   ...
   if npcId == TALIEN :
       if cond == 0 :
         if id == State.COMPLETED :
           ...
           st.exitQuest(1)
       if not player.isSubClassActive() or st.getPlayer().isNoble() :
         htmltext = "<html><body>This quest may only be undertaken by sub-class characters of level 50 or above and not have status nobles.</body></html>"
       elif cond == 1 :
