...
ITEMINICIAL = 7089
ITEM0 = 0
Items = [7080,7523,7081,7501,7284,7315,7346,7377,7408,7439,7089,0]
...
class Quest (JQuest) :
 ...
 def __init__(self,id,name,descr): 
     ...
     questItemIds = [7080,7523,7081,7501,7284,7315,7346,7377,7408,7439,7089,0]+[ITEMINICIAL,ITEMHOTSPRING,ITEMHOT1,AMULET1,AMULET2,AMULET3,AMULET4,AMULET5,AMULET6,HALISHAMARK,DIVINESTONE,ITEM0]	  
 ...
 def onAdvEvent (self,event,npc, player) :
   ...
   if event == "accept" :
       ...
       if st.getInt("Quest0") == 0 and not player.isInParty() :
           ...
           Mob_3 = st.addSpawn(LUNA,XDOIS,YDOIS,ZDOIS)
...
QUEST = Quest(86,qn,"Saga of the Hierophant")
