...
ITEMINICIAL = 7088
ITEM0 = 0
Items = [7080,7524,7081,7502,7285,7316,7347,7378,7409,7440,7088,0]
...
class Quest (JQuest) :
 ...
 def __init__(self,id,name,descr): 
     ...
     questItemIds = [7080,7524,7081,7502,7285,7316,7347,7378,7409,7440,7088,0]+[ITEMINICIAL,ITEMHOTSPRING,ITEMHOT1,AMULET1,AMULET2,AMULET3,AMULET4,AMULET5,AMULET6,HALISHAMARK,DIVINESTONE,ITEM0]	  
 ...
 def onAdvEvent (self,event,npc, player) :
   ...
   if event == "accept" :
       ...
       if st.getInt("Quest0") == 0 and not player.isInParty() :
           ...
           Mob_3 = st.addSpawn(ELIKIA,XDOIS,YDOIS,ZDOIS)
...
QUEST = Quest(87,qn,"Saga of Eva's Saint")
...
QUEST.addTalkId(DUNCAN)
QUEST.addTalkId(AGNES)
QUEST.addTalkId(BASTIAN)
QUEST.addTalkId(ELIKIA)
