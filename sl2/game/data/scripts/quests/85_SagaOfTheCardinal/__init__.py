...
ITEMINICIAL = 7087
ITEM0 = 0
Items = [7080,7522,7081,7500,7283,7314,7345,7376,7407,7438,7087,0]
...
class Quest (JQuest) :
 ...
 def __init__(self,id,name,descr): 
     ...
     questItemIds = [7080,7522,7081,7500,7283,7314,7345,7376,7407,7438,7087,0]+[ITEMINICIAL,ITEMHOTSPRING,ITEMHOT1,AMULET1,AMULET2,AMULET3,AMULET4,AMULET5,AMULET6,HALISHAMARK,DIVINESTONE,ITEM0]	  
 ...
 def onAdvEvent (self,event,npc, player) :
   ...
   if event == "accept" :
       ...
       if st.getInt("Quest0") == 0 and not player.isInParty() :
           ...
           Mob_3 = st.addSpawn(FRANZ,XDOIS,YDOIS,ZDOIS)
...
QUEST = Quest(85,qn,"Saga of the Cardinal")
