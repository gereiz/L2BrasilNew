...
ITEMINICIAL = 7093
ITEM0 = 6482
Items = [7080,7534,7081,7485,7268,7299,7330,7361,7392,7423,7093,6482]
 ...
 def onAdvEvent (self,event,npc, player) :
   ...
   if event == "accept" :
       ...
       if st.getInt("Quest0") == 0 and not player.isInParty() :
           ...
           Mob_3 = st.addSpawn(ERIC,XDOIS,YDOIS,ZDOIS)
...
QUEST = Quest(70,qn,"Saga of the Phoenix Knight")

QUEST.addStartNpc(SEDRICK)

QUEST.addAttackId(MOBTRES)

QUEST.addTalkId(SEDRICK)
QUEST.addTalkId(DONATH)
QUEST.addTalkId(FELIX)
QUEST.addTalkId(SEDRICK1)
