 ...
 def onAdvEvent (self, event, npc, player) :
   ...
   if event == "31372-04.htm" :
	   ...
	   if self.gstate.getState() == StateEnum.INTERVAL :
           ...
           spawnedNpc.broadcastPacket(NpcSay(spawnedNpc.getObjectId(),0,spawnedNpc.getNpcId(),"The water charm then is the storm and the tsunami strength! Opposes with it only has the blind alley!"))
   return htmltext
