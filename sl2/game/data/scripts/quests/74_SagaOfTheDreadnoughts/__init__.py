...
Items = [7080,7538,7081,7489,7272,7303,7334,7365,7396,7427,7097,6480]
...
class Quest (JQuest) :
 ...
 def __init__(self,id,name,descr): 
     ...
     questItemIds = [7080,7534,7081,7485,7268,7299,7330,7361,7392,7423,7093,6482]+[ITEMINICIAL,ITEMHOTSPRING,ITEMHOT1,AMULET1,AMULET2,AMULET3,AMULET4,AMULET5,AMULET6,HALISHAMARK,DIVINESTONE,ITEM0]	  
 ...
 def onAdvEvent (self,event,npc, player) :
   ...
   if event == "accept" :
       ...
       if st.getInt("Quest0") == 0 and not player.isInParty() :
           ...
           Mob_3 = st.addSpawn(LEONA,XDOIS,YDOIS,ZDOIS)
    ...
    if st :
      ...
      if player.getClassId().getId() == prevclass :
          if cond == 0 :
              ...
              if npcId == DONATH :
                  if st.getQuestItemsCount(ITEMHOTSPRING) and st.getQuestItemsCount(ITEM0) : 
                      if 0 == 0 :
                          htmltext = "1-03.htm"
...
QUEST = Quest(74,qn,"Saga of the Dreadnoughts")

QUEST.addStartNpc(AIKEN)

QUEST.addAttackId(MOBTRES)

QUEST.addTalkId(AIKEN)
QUEST.addTalkId(DONATH)
QUEST.addTalkId(ULRICH)
QUEST.addTalkId(BERNHARD)
QUEST.addTalkId(LEONA)
