...
Items = [7080,7539,7081,7492,7275,7306,7337,7368,7399,7430,7100,0]
...
class Quest (JQuest) :
 ...
 def __init__(self,id,name,descr): 
     ...
     questItemIds = [7080,7539,7081,7492,7275,7306,7337,7368,7399,7430,7100,0]+[ITEMINICIAL,ITEMHOTSPRING,ITEMHOT1,AMULET1,AMULET2,AMULET3,AMULET4,AMULET5,AMULET6,HALISHAMARK,DIVINESTONE,ITEM0]	  
 ...
 def onAdvEvent (self,event,npc, player) :
   ...
   if event == "accept" :
       ...
       if st.getInt("Quest0") == 0 and not player.isInParty() :
           ...
           Mob_3 = st.addSpawn(AKKAN,XDOIS,YDOIS,ZDOIS)
...
QUEST = Quest(77,qn,"Saga of the Dominator")
