...
Items = [7080,7539,7081,7491,7274,7305,7336,7367,7398,7429,7099,0]
...
class Quest (JQuest) :
 ...
 def __init__(self,id,name,descr): 
     ...
     questItemIds = [7080,7539,7081,7491,7274,7305,7336,7367,7398,7429,7099,0]+[ITEMINICIAL,ITEMHOTSPRING,ITEMHOT1,AMULET1,AMULET2,AMULET3,AMULET4,AMULET5,AMULET6,HALISHAMARK,DIVINESTONE,ITEM0]	  
 ...
 def onAdvEvent (self,event,npc, player) :
   ...
   if event == "accept" :
       ...
       if st.getInt("Quest0") == 0 and not player.isInParty() :
           ...
           Mob_3 = st.addSpawn(KASHU,XDOIS,YDOIS,ZDOIS)
...
QUEST = Quest(76,qn,"Saga of the Grand Khavatari")

QUEST.addStartNpc(HAKRAN)

QUEST.addAttackId(MOBTRES)

QUEST.addTalkId(HAKRAN)
QUEST.addTalkId(DONATH)
QUEST.addTalkId(DUDAMARA)
QUEST.addTalkId(SKAHI)
QUEST.addTalkId(KASHU)
