...
ITEMINICIAL = 7109
ITEM0 = 0
Items = [7080,7608,7081,7514,7297,7328,7359,7390,7421,7452,7109,0]
...
class Quest (JQuest) :
 ...
 def __init__(self,id,name,descr): 
     ...
     questItemIds = [7080,7608,7081,7514,7297,7328,7359,7390,7421,7452,7109,0]+[ITEMINICIAL,ITEMHOTSPRING,ITEMHOT1,AMULET1,AMULET2,AMULET3,AMULET4,AMULET5,AMULET6,HALISHAMARK,DIVINESTONE,ITEM0]	  
 ...
 def onAdvEvent (self,event,npc, player) :
   ...
   if event == "accept" :
       ...
       if st.getInt("Quest0") == 0 and not player.isInParty() :
           ...
           Mob_3 = st.addSpawn(APRODIA,XDOIS,YDOIS,ZDOIS)
...
QUEST = Quest(99,qn,"Saga of the Fortune Seeker")

QUEST.addStartNpc(MOND)

QUEST.addAttackId(MOBTRES)

QUEST.addTalkId(MOND)
QUEST.addTalkId(BAVARIN)
QUEST.addTalkId(PAMELA)
QUEST.addTalkId(PAMELA1)
QUEST.addTalkId(APRODIA)
