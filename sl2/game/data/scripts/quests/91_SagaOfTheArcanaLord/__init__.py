...
ITEMINICIAL = 7110
ITEM0 = 0
Items = [7080,7604,7081,7506,7289,7320,7351,7382,7413,7444,7110,0]
...
class Quest (JQuest) :
 ...
 def __init__(self,id,name,descr): 
     ...
     questItemIds = [7080,7604,7081,7506,7289,7320,7351,7382,7413,7444,7110,0]+[ITEMINICIAL,ITEMHOTSPRING,ITEMHOT1,AMULET1,AMULET2,AMULET3,AMULET4,AMULET5,AMULET6,HALISHAMARK,DIVINESTONE,ITEM0]	  
 ...
 def onAdvEvent (self,event,npc, player) :
   ...
   if event == "accept" :
       ...
       if st.getInt("Quest0") == 0 and not player.isInParty() :
           ...
           Mob_3 = st.addSpawn(SPARKY1,XDOIS,YDOIS,ZDOIS)
...
QUEST = Quest(91,qn,"Saga of the Arcana Lord")

QUEST.addStartNpc(KINSLEY)

QUEST.addAttackId(MOBTRES)

QUEST.addTalkId(KINSLEY)
QUEST.addTalkId(KEATS)
QUEST.addTalkId(SPARKY)
QUEST.addTalkId(BELINDA)
QUEST.addTalkId(SPARKY1)
