...
ITEMINICIAL = 7098
ITEM0 = 0
Items = [7080,7539,7081,7490,7273,7304,7335,7366,7397,7428,7098,0]
...
class Quest (JQuest) :
 ...
 def __init__(self,id,name,descr): 
     ...
     questItemIds = [7080,7539,7081,7490,7273,7304,7335,7366,7397,7428,7098,0]+[ITEMINICIAL,ITEMHOTSPRING,ITEMHOT1,AMULET1,AMULET2,AMULET3,AMULET4,AMULET5,AMULET6,HALISHAMARK,DIVINESTONE,ITEM0]	  
 ...
 def onAdvEvent (self,event,npc, player) :
   ...
   if event == "accept" :
       ...
       if st.getInt("Quest0") == 0 and not player.isInParty() :
           ...
           Mob_3 = st.addSpawn(HESTUI,XDOIS,YDOIS,ZDOIS)
...
QUEST = Quest(75,qn,"Saga of the Titan")

QUEST.addStartNpc(TAZKI)

QUEST.addAttackId(MOBTRES)

QUEST.addTalkId(TAZKI)
QUEST.addTalkId(DONATH)
QUEST.addTalkId(LAKAN)
QUEST.addTalkId(SKAHI)
QUEST.addTalkId(HESTUI)
