...
ITEMINICIAL = 7111
ITEM0 = 0
Items = [7080,7605,7081,7507,7290,7321,7352,7383,7414,7445,7111,0]
...
class Quest (JQuest) :
 ...
 def __init__(self,id,name,descr): 
     ...
     questItemIds = [7080,7605,7081,7507,7290,7321,7352,7383,7414,7445,7111,0]+[ITEMINICIAL,ITEMHOTSPRING,ITEMHOT1,AMULET1,AMULET2,AMULET3,AMULET4,AMULET5,AMULET6,HALISHAMARK,DIVINESTONE,ITEM0]	  
 ...
 def onAdvEvent (self,event,npc, player) :
   ...
   if event == "accept" :
       ...
       if st.getInt("Quest0") == 0 and not player.isInParty() :
           ...
           Mob_3 = st.addSpawn(KALEIDOS,XDOIS,YDOIS,ZDOIS)
...
QUEST = Quest(92,qn,"Saga of the Elemental Master")

QUEST.addStartNpc(ARKENIAS)

QUEST.addAttackId(MOBTRES)

QUEST.addTalkId(ARKENIAS)
QUEST.addTalkId(CERENAS)
QUEST.addTalkId(RADYSS)
QUEST.addTalkId(RADYSS1)
QUEST.addTalkId(KALEIDOS)
