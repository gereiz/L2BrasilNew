...
ITEMINICIAL = 7101
ITEM0 = 0
Items = [7080,7539,7081,7493,7276,7307,7338,7369,7400,7431,7101,0]
...
class Quest (JQuest) :
 ...
 def __init__(self,id,name,descr): 
     ...
     questItemIds = [7080,7539,7081,7493,7276,7307,7338,7369,7400,7431,7101,0]+[ITEMINICIAL,ITEMHOTSPRING,ITEMHOT1,AMULET1,AMULET2,AMULET3,AMULET4,AMULET5,AMULET6,HALISHAMARK,DIVINESTONE,ITEM0]	  
 ...
 def onAdvEvent (self,event,npc, player) :
   ...
   if event == "accept" :
       ...
       if st.getInt("Quest0") == 0 and not player.isInParty() :
           ...
           Mob_3 = st.addSpawn(TARKAI,XDOIS,YDOIS,ZDOIS)
...
QUEST = Quest(78,qn,"Saga of the Doomcryer")

QUEST.addStartNpc(RAHORAKTI)
