...
from com.dream.game.manager    import FourSepulchersManager
...
class Quest (JQuest) :
  ...
  def __init__(self,id,name,descr):
      ...
      self.questItemIds = [ANTIQUE_BROOCH,SEALED_BOX,ALECTIA,TISHAS,MEKARA,MORIGUL,7256,7257,7258,7259,GRAVE_PASS]
    ...
    if npcId == HALISHA1 :
        ...
        if party :
            ...
            for partyMember in party.getPartyMembers().toArray() :
                    ...
                    if pst :
                        if not pst.getQuestItemsCount(ALECTIA) :										
                            if pst.getInt("cond") == 1 or pst.getInt("cond") == 2 :					
                                pst.giveItems(ALECTIA,1)
                                pst.playSound("ItemSound.quest_itemget")
        else :
            st1 = player.getQuestState(qn)
            if st1 :
               if not st.getQuestItemsCount(ALECTIA) : 
                  if st1.getInt("cond") == 1 or st1.getInt("cond") == 2 :
                       st1.giveItems(ALECTIA,1)
    ...
    if npcId == HALISHA2 :
        ...
        if party :
            ...
            for partyMember in party.getPartyMembers().toArray() :
                    pst = partyMember.getQuestState(qn)
                    if pst :
                        if not pst.getQuestItemsCount(TISHAS) :										
                            if pst.getInt("cond") == 1 or pst.getInt("cond") == 2 :					
                                pst.giveItems(TISHAS,1)
                                pst.playSound("ItemSound.quest_itemget")
        else :
            st1 = player.getQuestState(qn)
            if st1 :
               if not st.getQuestItemsCount(TISHAS) : 
                  if st1.getInt("cond") == 1 or st1.getInt("cond") == 2 :
                       st1.giveItems(TISHAS,1)
                       st1.playSound("ItemSound.quest_itemget") 
    if npcId == HALISHA3 :
        party = player.getParty()
        if party :
            ...
            for partyMember in party.getPartyMembers().toArray() :
                    pst = partyMember.getQuestState(qn)
                    if pst :
                        if not pst.getQuestItemsCount(MEKARA) :										
                            if pst.getInt("cond") == 1 or pst.getInt("cond") == 2 :					
                                pst.giveItems(MEKARA,1)
                                pst.playSound("ItemSound.quest_itemget")
        else :
            st1 = player.getQuestState(qn)
            if st1 :
               if not st.getQuestItemsCount(MEKARA) : 
                  if st1.getInt("cond") == 1 or st1.getInt("cond") == 2 :
                       st1.giveItems(MEKARA,1)
                       st1.playSound("ItemSound.quest_itemget") 
    if npcId == HALISHA4 :
        party = player.getParty()
        if party :
            ...
            for partyMember in party.getPartyMembers().toArray() :
                    pst = partyMember.getQuestState(qn)
                    if pst :
                        if not pst.getQuestItemsCount(MORIGUL) :										
                            if pst.getInt("cond") == 1 or pst.getInt("cond") == 2 :					
                                pst.giveItems(MORIGUL,1)
                                pst.playSound("ItemSound.quest_itemget")
        else :
            st1 = player.getQuestState(qn)
            if st1 :
               if not st.getQuestItemsCount(MORIGUL) : 
                  if st1.getInt("cond") == 1 or st1.getInt("cond") == 2 :
                       st1.giveItems(MORIGUL,1)
                       st1.playSound("ItemSound.quest_itemget") 
    return
  ...
  def onAdvEvent (self,event,npc,player) :
    ...
    if not st : return
      ...
      while (st.getQuestItemsCount(SEALED_BOX) > 0) :
...
QUEST.addKillId(HALISHA1)
QUEST.addKillId(HALISHA2)
QUEST.addKillId(HALISHA3)
QUEST.addKillId(HALISHA4)