# Made by Fulminus, version 0.
# Update by m095, 11/10/09
import sys
  ...
  def onTalk (self,npc,player):
    ...
    # if quest is accepted and in progress
      ...
      ## KASPAR
        ...
        if cond==7 and st.getQuestItemsCount(PIPETTE_KNIFE) and st.getQuestItemsCount(RED_PIPETTE_KNIFE) :
