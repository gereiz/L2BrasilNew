...
ITEMINICIAL = 7112
ITEM0 = 0
Items = [7080,7606,7081,7508,7291,7322,7353,7384,7415,7446,7112,0]
...
class Quest (JQuest) :
 ...
 def __init__(self,id,name,descr): 
     ...
     questItemIds = [7080,7606,7081,7508,7291,7322,7353,7384,7415,7446,7112,0]+[ITEMINICIAL,ITEMHOTSPRING,ITEMHOT1,AMULET1,AMULET2,AMULET3,AMULET4,AMULET5,AMULET6,HALISHAMARK,DIVINESTONE,ITEM0]	  
 ...
 def onAdvEvent (self,event,npc, player) :
   ...
   if event == "accept" :
       ...
       if st.getInt("Quest0") == 0 and not player.isInParty() :
           ...
           Mob_3 = st.addSpawn(MYSTERIOUS,XDOIS,YDOIS,ZDOIS)
...
QUEST = Quest(93,qn,"Saga of the Spectral Master")
...
QUEST.addTalkId(NOCTISSE)
QUEST.addTalkId(FAIREN1)
QUEST.addTalkId(MYSTERIOUS)
