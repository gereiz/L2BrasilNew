...
27098:[5,5,50,FLAME_CRYSTAL,2],
20230:[5,20,30,DAZZLING_DROP,2],
20231:[5,20,30,DAZZLING_DROP,2],
20157:[5,20,30,DAZZLING_DROP,2],
20232:[5,20,40,DAZZLING_DROP,2],
20234:[5,20,50,DAZZLING_DROP,2],
20145:[5,20,50,HARPYS_FEATHER,2],
20176:[5,10,50,WYRMS_WINGBONE,2],
20553:[5,10,50,WINDSUS_MANE,2],
20564:[5,10,100,EN_MONSTEREYE_SHELL,2],
20565:[5,10,100,EN_STONEGOLEM_POWDER,2],
20566:[5,10,100,EN_IRONGOLEM_SCRAP,2]
}
...
class Quest (JQuest) :
 ...
 def onTalk (self,npc,player):
   ...
   if npcId == 30629 :
     ...
     elif st.getInt("cond")<4 and st.getInt("cond")>2:
