 ...
 def onAdvEvent (self, event, npc, player) :
   ...
   if event == "31371-04.htm" :
       ...
       if Thief_Key:
        ...
        npc.broadcastPacket(NpcSay(npc.getObjectId(),0,npc.getNpcId(),"I'll be waiting for your return"))
        st.set("spawned","0")
        return
   return htmltext
            ...
            if st.getInt("spawned") == 0 and npc.getObjectId() != st.getInt("npcid"):
                if npcId in Varka_Mobs :
                    if id > 2 :
                        ...
                        spawnedNpc.broadcastPacket(NpcSay(spawnedNpc.getObjectId(),0,spawnedNpc.getNpcId(),"You cannot escape Asefa's eyes!"))
