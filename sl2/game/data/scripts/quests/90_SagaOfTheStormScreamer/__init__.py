...
ITEMINICIAL = 7084
ITEM0 = 0
Items = [7080,7531,7081,7505,7288,7319,7350,7381,7412,7443,7084,0]
...
class Quest (JQuest) :
 ...
 def __init__(self,id,name,descr): 
     ...
     questItemIds = [7080,7531,7081,7505,7288,7319,7350,7381,7412,7443,7084,0]+[ITEMINICIAL,ITEMHOTSPRING,ITEMHOT1,AMULET1,AMULET2,AMULET3,AMULET4,AMULET5,AMULET6,HALISHAMARK,DIVINESTONE,ITEM0]	  
 ...
 def onAdvEvent (self,event,npc, player) :
   ...
   if event == "accept" :
       ...
       if st.getInt("Quest0") == 0 and not player.isInParty() :
           ...
           Mob_3 = st.addSpawn(MEDINA,XDOIS,YDOIS,ZDOIS)
