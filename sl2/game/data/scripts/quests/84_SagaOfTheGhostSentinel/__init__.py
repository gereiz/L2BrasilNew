...
ITEMINICIAL = 7107
ITEM0 = 0
Items = [7080,7521,7081,7499,7282,7313,7344,7375,7406,7437,7107,0]
...
class Quest (JQuest) :
 ...
 def __init__(self,id,name,descr): 
     ...
     questItemIds = [7080,7521,7081,7499,7282,7313,7344,7375,7406,7437,7107,0]+[ITEMINICIAL,ITEMHOTSPRING,ITEMHOT1,AMULET1,AMULET2,AMULET3,AMULET4,AMULET5,AMULET6,HALISHAMARK,DIVINESTONE,ITEM0]	  
 ...
 def onAdvEvent (self,event,npc, player) :
   ...
   if event == "accept" :
       ...
       if st.getInt("Quest0") == 0 and not player.isInParty() :
           ...
           Mob_3 = st.addSpawn(KADYTH,XDOIS,YDOIS,ZDOIS)
...
QUEST = Quest(84,qn,"Saga of the Ghost Sentinel")

QUEST.addStartNpc(BERNARD)

QUEST.addAttackId(MOBTRES)

QUEST.addTalkId(BERNARD)
QUEST.addTalkId(GEDRIK)
QUEST.addTalkId(GRIMST)
QUEST.addTalkId(PILGRIM)
QUEST.addTalkId(KADYTH)
