...
ITEMINICIAL = 7083
ITEM0 = 0
Items = [7080,7530,7081,7504,7287,7318,7349,7380,7411,7442,7083,0]
...
class Quest (JQuest) :
 ...
 def __init__(self,id,name,descr): 
     ...
     questItemIds = [7080,7530,7081,7504,7287,7318,7349,7380,7411,7442,7083,0]+[ITEMINICIAL,ITEMHOTSPRING,ITEMHOT1,AMULET1,AMULET2,AMULET3,AMULET4,AMULET5,AMULET6,HALISHAMARK,DIVINESTONE,ITEM0]	  
 ...
 def onAdvEvent (self,event,npc, player) :
   ...
   if event == "accept" :
       ...
       if st.getInt("Quest0") == 0 and not player.isInParty() :
           ...
           Mob_3 = st.addSpawn(FEYSHAR,XDOIS,YDOIS,ZDOIS)
...
QUEST = Quest(89,qn,"Saga of the Mystic Muse")
...
QUEST.addTalkId(ALMINAS)
QUEST.addTalkId(ALMINAS1)
QUEST.addTalkId(FEYSHAR)
