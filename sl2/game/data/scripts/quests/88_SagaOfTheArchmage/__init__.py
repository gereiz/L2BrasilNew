...
ITEMINICIAL = 7082
ITEM0 = 0
Items = [7080,7529,7081,7503,7286,7317,7348,7379,7410,7441,7082,0]
...
class Quest (JQuest) :
 ...
 def __init__(self,id,name,descr): 
     ...
     questItemIds = [7080,7529,7081,7503,7286,7317,7348,7379,7410,7441,7082,0]+[ITEMINICIAL,ITEMHOTSPRING,ITEMHOT1,AMULET1,AMULET2,AMULET3,AMULET4,AMULET5,AMULET6,HALISHAMARK,DIVINESTONE,ITEM0]	  
 ...
 def onAdvEvent (self,event,npc, player) :
   ...
   if event == "accept" :
       ...
       if st.getInt("Quest0") == 0 and not player.isInParty() :
           ...
           Mob_3 = st.addSpawn(DEVIANNE,XDOIS,YDOIS,ZDOIS)
...
QUEST = Quest(88,qn,"Saga of the Archmage")

QUEST.addStartNpc(VALLERIA)

QUEST.addAttackId(MOBTRES)

QUEST.addTalkId(VALLERIA)
QUEST.addTalkId(MIST)
QUEST.addTalkId(JUSTIN)
QUEST.addTalkId(JUSTIN1)
QUEST.addTalkId(DEVIANNE)
