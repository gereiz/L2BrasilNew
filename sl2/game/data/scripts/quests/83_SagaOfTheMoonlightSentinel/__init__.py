...
ITEMINICIAL = 7106
ITEM0 = 0
Items = [7080,7520,7081,7498,7281,7312,7343,7374,7405,7436,7106,0]
...
class Quest (JQuest) :
 ...
 def __init__(self,id,name,descr): 
     ...
     questItemIds = [7080,7520,7081,7498,7281,7312,7343,7374,7405,7436,7106,0]+[ITEMINICIAL,ITEMHOTSPRING,ITEMHOT1,AMULET1,AMULET2,AMULET3,AMULET4,AMULET5,AMULET6,HALISHAMARK,DIVINESTONE,ITEM0]	  
...
QUEST = Quest(83,qn,"Saga of the Moonlight Sentinel")
