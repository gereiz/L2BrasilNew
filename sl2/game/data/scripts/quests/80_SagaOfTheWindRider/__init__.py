...
ITEMINICIAL = 7103
ITEM0 = 0
Items = [7080,7517,7081,7495,7278,7309,7340,7371,7402,7433,7103,0]
...
class Quest (JQuest) :
 ...
 def __init__(self,id,name,descr): 
     ...
     questItemIds = [7080,7517,7081,7495,7278,7309,7340,7371,7402,7433,7103,0]+[ITEMINICIAL,ITEMHOTSPRING,ITEMHOT1,AMULET1,AMULET2,AMULET3,AMULET4,AMULET5,AMULET6,HALISHAMARK,DIVINESTONE,ITEM0]	  
 ...
 def onAdvEvent (self,event,npc, player) :
   ...
   if event == "accept" :
       ...
       if st.getInt("Quest0") == 0 and not player.isInParty() :
           ...
           Mob_3 = st.addSpawn(STARIS,XDOIS,YDOIS,ZDOIS)
...
QUEST = Quest(80,qn,"Saga of the Wind Rider")

QUEST.addStartNpc(BLACKCAT)

QUEST.addAttackId(MOBTRES)

QUEST.addTalkId(BLACKCAT)
QUEST.addTalkId(DONATH)
QUEST.addTalkId(ELENA)
QUEST.addTalkId(HERMIT)
QUEST.addTalkId(STARIS)
