...
ITEMINICIAL = 7108
ITEM0 = 0
Items = [7080,7607,7081,7515,7298,7329,7360,7391,7422,7453,7108,0]
...
class Quest (JQuest) :
 ...
 def __init__(self,id,name,descr): 
     ...
     questItemIds = [7080,7607,7081,7515,7298,7329,7360,7391,7422,7453,7108,0]+[ITEMINICIAL,ITEMHOTSPRING,ITEMHOT1,AMULET1,AMULET2,AMULET3,AMULET4,AMULET5,AMULET6,HALISHAMARK,DIVINESTONE,ITEM0]	  
 ...
 def onAdvEvent (self,event,npc, player) :
   ...
   if event == "accept" :
       ...
       if st.getInt("Quest0") == 0 and not player.isInParty() :
           ...
           Mob_3 = st.addSpawn(TOBALD3,XDOIS,YDOIS,ZDOIS)
...
QUEST = Quest(100,qn,"Saga of the Maestro")

QUEST.addStartNpc(TELSON)

QUEST.addAttackId(MOBTRES)

QUEST.addTalkId(TELSON)
QUEST.addTalkId(BORODIN)
QUEST.addTalkId(TOBALD)
QUEST.addTalkId(TOBALD1)
QUEST.addTalkId(TOBALD3)
