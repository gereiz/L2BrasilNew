...
Items = [7080,7537,7081,7488,7271,7302,7333,7364,7395,7426,7096,7546]
 ...
 def onAdvEvent (self,event,npc, player) :
   ...
   if event == "accept" :
       ...
       if st.getInt("Quest0") == 0 and not player.isInParty() :
           ...
           Mob_3 = st.addSpawn(KAIN,XDOIS,YDOIS,ZDOIS)
...
QUEST = Quest(73,qn,"Saga of the Duelist")
...
QUEST.addTalkId(DIRECTOR)
QUEST.addTalkId(VALDIS)
QUEST.addTalkId(KAIN)
