...
Items = [7080,7535,7081,7486,7269,7300,7331,7362,7393,7424,7094,6482]
...
class Quest (JQuest) :
 ...
 def __init__(self,id,name,descr): 
     ...
     questItemIds = [7080,7535,7081,7486,7269,7300,7331,7362,7393,7424,7094,6482]+[ITEMHOTSPRING,ITEMHOT1,DIVINESTONE,HALISHAMARK,AMULET1,AMULET2,AMULET3,AMULET4,AMULET5,AMULET6,ITEMINICIAL,ITEM0]
 ...
 def onAdvEvent (self,event,npc, player) :
   ...
   if event == "accept" :
       ...
       if st.getInt("Quest0") == 0 and not player.isInParty() :
           ...
           Mob_3 = st.addSpawn(KASTIEN,XDOIS,YDOIS,ZDOIS)
...
QUEST = Quest(71,qn,"Saga of Eva's Templar")

QUEST.addStartNpc(SINDEN)

QUEST.addAttackId(MOBTRES)

QUEST.addTalkId(SINDEN)
QUEST.addTalkId(DONATH)
QUEST.addTalkId(BRONWYN)
QUEST.addTalkId(SINDEN1)
QUEST.addTalkId(KASTIEN)
