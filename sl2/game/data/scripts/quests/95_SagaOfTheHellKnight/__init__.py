...
ITEMINICIAL = 7086
ITEM0 = 0
Items = [7080,7532,7081,7510,7293,7324,7355,7386,7417,7448,7086,0]
...
class Quest (JQuest) :
 ...
 def __init__(self,id,name,descr): 
     ...
     questItemIds = [7080,7532,7081,7510,7293,7324,7355,7386,7417,7448,7086,0]+[ITEMINICIAL,ITEMHOTSPRING,ITEMHOT1,AMULET1,AMULET2,AMULET3,AMULET4,AMULET5,AMULET6,HALISHAMARK,DIVINESTONE,ITEM0]	  
 ...
 def onAdvEvent (self,event,npc, player) :
   ...
   if event == "accept" :
       ...
       if st.getInt("Quest0") == 0 and not player.isInParty() :
           ...
           Mob_3 = st.addSpawn(WALDSTAIN,XDOIS,YDOIS,ZDOIS)
...
QUEST = Quest(95,qn,"Saga of the Hell Knight")

QUEST.addStartNpc(MORDRED)

QUEST.addAttackId(MOBTRES)

QUEST.addTalkId(MORDRED)
QUEST.addTalkId(BAVARIN)
QUEST.addTalkId(BAYARD)
QUEST.addTalkId(BAYARD1)
QUEST.addTalkId(WALDSTAIN)
