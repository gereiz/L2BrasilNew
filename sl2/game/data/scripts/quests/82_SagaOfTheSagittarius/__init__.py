...
ITEMINICIAL = 7105
ITEM0 = 0
Items = [7080,7519,7081,7497,7280,7311,7342,7373,7404,7435,7105,0]
...
class Quest (JQuest) :
 ...
 def __init__(self,id,name,descr): 
     ...
     questItemIds = [7080,7519,7081,7497,7280,7311,7342,7373,7404,7435,7105,0]+[ITEMINICIAL,ITEMHOTSPRING,ITEMHOT1,AMULET1,AMULET2,AMULET3,AMULET4,AMULET5,AMULET6,HALISHAMARK,DIVINESTONE,ITEM0]	  
...
QUEST = Quest(82,qn,"Saga of the Sagittarius")
