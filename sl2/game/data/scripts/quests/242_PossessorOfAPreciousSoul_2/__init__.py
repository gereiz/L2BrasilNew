...
class Quest (JQuest) :
 ...
 def onAdvEvent (self,event,npc,player) :
   ...
   if event == "31742-3.htm" :
     ...
     Angel = st.addSpawn(ANGEL_CORPSE,npc.getX() + Rnd.get(-150, 150), npc.getY() + Rnd.get(-150, 150), npc.getZ(), 0,)
     Angel1 = st.addSpawn(ANGEL_CORPSE,npc.getX() + Rnd.get(-150, 150), npc.getY() + Rnd.get(-150, 150), npc.getZ(), 0,)
     Angel2 = st.addSpawn(ANGEL_CORPSE,npc.getX() + Rnd.get(-150, 150), npc.getY() + Rnd.get(-150, 150), npc.getZ(), 0,)
     return
   return htmltext
   ...
   if player.isSubClassActive() :
     if npcId == VIRGIL :
         ...
         if cond == 3 :
             ...
             st.startQuestTimer("3",30000,npc)
             st.set("cond","6")
             st.playSound("ItemSound.quest_middle")
         elif cond == 6 :
         ...
         if cond == 4 :
           if st.getInt("Talk") < 3 :
		   st.set("Talk",str(st.getInt("Talk")+1))
