...
ITEMINICIAL = 7091
ITEM0 = 0
Items = [7080,7526,7081,7512,7295,7326,7357,7388,7419,7450,7091,0]
...
class Quest (JQuest) :
 ...
 def __init__(self,id,name,descr): 
     ...
     questItemIds = [7080,7526,7081,7512,7295,7326,7357,7388,7419,7450,7091,0]+[ITEMINICIAL,ITEMHOTSPRING,ITEMHOT1,AMULET1,AMULET2,AMULET3,AMULET4,AMULET5,AMULET6,HALISHAMARK,DIVINESTONE,ITEM0]	  
 ...
 def onAdvEvent (self,event,npc, player) :
   ...
   if event == "accept" :
       ...
       if st.getInt("Quest0") == 0 and not player.isInParty() :
           ...
           Mob_3 = st.addSpawn(SHIKEN,XDOIS,YDOIS,ZDOIS)
...
QUEST = Quest(97,qn,"Saga of the Shillien Templar")

QUEST.addStartNpc(GALADRI)

QUEST.addAttackId(MOBTRES)

QUEST.addTalkId(GALADRI)
QUEST.addTalkId(BAVARIN)
QUEST.addTalkId(SAMAEL)
QUEST.addTalkId(SAMAEL1)
QUEST.addTalkId(SHIKEN)
