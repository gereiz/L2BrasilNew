...
ITEMINICIAL = 7102
ITEM0 = 0
Items = [7080,7516,7081,7494,7277,7308,7339,7370,7401,7432,7102,0]
...
class Quest (JQuest) :
 ...
 def __init__(self,id,name,descr): 
     ...
     questItemIds = [7080,7516,7081,7494,7277,7308,7339,7370,7401,7432,7102,0]+[ITEMINICIAL,ITEMHOTSPRING,ITEMHOT1,AMULET1,AMULET2,AMULET3,AMULET4,AMULET5,AMULET6,HALISHAMARK,DIVINESTONE,ITEM0]	  
 ...
 def onAdvEvent (self,event,npc, player) :
   ...
   if event == "accept" :
       ...
       if st.getInt("Quest0") == 0 and not player.isInParty() :
           ...
           Mob_3 = st.addSpawn(ERICA,XDOIS,YDOIS,ZDOIS)
...
QUEST = Quest(79,qn,"Saga of the Adventurer")
