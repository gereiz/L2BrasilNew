...
ITEMINICIAL = 7090
ITEM0 = 0
Items = [7080,7525,7081,7513,7296,7327,7358,7389,7420,7451,7090,0]
...
class Quest (JQuest) :
 ...
 def __init__(self,id,name,descr): 
     ...
     questItemIds = [7080,7525,7081,7513,7296,7327,7358,7389,7420,7451,7090,0]+[ITEMINICIAL,ITEMHOTSPRING,ITEMHOT1,AMULET1,AMULET2,AMULET3,AMULET4,AMULET5,AMULET6,HALISHAMARK,DIVINESTONE,ITEM0]	  
 ...
 def onAdvEvent (self,event,npc, player) :
   ...
   if event == "accept" :
       ...
       if st.getInt("Quest0") == 0 and not player.isInParty() :
           ...
           Mob_3 = st.addSpawn(ELCARDIA,XDOIS,YDOIS,ZDOIS)
...
QUEST = Quest(98,qn,"Saga of the Shillien Saint")

QUEST.addStartNpc(ANASTIA)

QUEST.addAttackId(MOBTRES)

QUEST.addTalkId(ANASTIA)
QUEST.addTalkId(BAVARIN)
QUEST.addTalkId(AGNES)
QUEST.addTalkId(KAMILEN)
QUEST.addTalkId(ELCARDIA)
