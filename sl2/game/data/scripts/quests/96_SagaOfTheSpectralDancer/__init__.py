...
ITEMINICIAL = 7092
ITEM0 = 0
Items = [7080,7527,7081,7511,7294,7325,7356,7387,7418,7449,7092,0]
...
class Quest (JQuest) :
 ...
 def __init__(self,id,name,descr): 
     ...
     questItemIds = [77080,7527,7081,7511,7294,7325,7356,7387,7418,7449,7092,0]+[ITEMINICIAL,ITEMHOTSPRING,ITEMHOT1,AMULET1,AMULET2,AMULET3,AMULET4,AMULET5,AMULET6,HALISHAMARK,DIVINESTONE,ITEM0]	  
 ...
 def onAdvEvent (self,event,npc, player) :
   ...
   if event == "accept" :
       ...
       if st.getInt("Quest0") == 0 and not player.isInParty() :
           ...
           Mob_3 = st.addSpawn(SCRYDE,XDOIS,YDOIS,ZDOIS)
...
QUEST = Quest(96,qn,"Saga of the Spectral Dancer")
...
QUEST.addTalkId(ELENA1)
QUEST.addTalkId(SCRYDE)
