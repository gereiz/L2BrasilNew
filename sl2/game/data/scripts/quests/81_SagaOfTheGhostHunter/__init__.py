...
ITEMINICIAL = 7104
ITEM0 = 0
Items = [7080,7518,7081,7496,7279,7310,7341,7372,7403,7434,7104,0]
...
class Quest (JQuest) :
 ...
 def __init__(self,id,name,descr): 
     ...
     questItemIds = [7080,7518,7081,7496,7279,7310,7341,7372,7403,7434,7104,0]+[ITEMINICIAL,ITEMHOTSPRING,ITEMHOT1,AMULET1,AMULET2,AMULET3,AMULET4,AMULET5,AMULET6,HALISHAMARK,DIVINESTONE,ITEM0]	  
 ...
 def onAdvEvent (self,event,npc, player) :
   ...
   if event == "accept" :
       ...
       if st.getInt("Quest0") == 0 and not player.isInParty() :
           ...
           Mob_3 = st.addSpawn(ARIA,XDOIS,YDOIS,ZDOIS)
...
QUEST = Quest(81,qn,"Saga of the Ghost Hunter")
...
QUEST.addTalkId(DRAKON)
QUEST.addTalkId(HERMIT)
QUEST.addTalkId(ARIA)
