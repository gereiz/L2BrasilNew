 ...
 */
package com.dream.auth.network.loginserverpackets;

import com.dream.tools.task.TaskPriority;

public abstract class AuthServerBasePacket
{
	private final byte[] _decrypt;
	private int _off;
	private String result;

	public AuthServerBasePacket(byte[] decrypt)
	{
		_decrypt = decrypt;
		_off = 1;
	}
