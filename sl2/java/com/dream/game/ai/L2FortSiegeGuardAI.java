...
public class L2FortSiegeGuardAI extends L2CharacterAI implements Runnable
{
	private static final class FortSiegeGuardAiTaskManager extends AbstractIterativePeriodicTaskManager<L2FortSiegeGuardAI>
	{
		...
		public static FortSiegeGuardAiTaskManager getInstance()
		{
			return _instance;
		}
	...
	{
		if (target == null || target instanceof L2FortSiegeGuardInstance || target instanceof L2FortCommanderInstance || target instanceof L2NpcInstance || target instanceof L2DoorInstance || target instanceof L2Playable)
		{
