...
public class AdminQuest extends gmHandler
{
	...
	private static void setquestvar(L2PcInstance target, L2PcInstance actor, String[] val)
	{
		...
		actor.sendChatMessage(0, SystemChatChannelId.Chat_None, "SYS", "Successfully changed the character quests");
		outval[0] = "name";
		outval[1] = val[0];
		try
		{
	...
	private static void showquestmenu(L2PcInstance target, L2PcInstance actor, String[] val)
	{
		...
		{
			actor.sendChatMessage(0, SystemChatChannelId.Chat_None, "SYS", "Error!");
		}
	}
	...
	public void runCommand(L2PcInstance admin, String... params)
	{
		...
		if (params.length > 1)
		{
			...
			if (params.length > 2)
			{
				...
				if (params[2].equals("3"))
				{
					val[0] = "full";
				}
				if (params[2].indexOf("_") != -1)
				{
					val[0] = "name";
					val[1] = params[2];
				}
