...
import com.dream.game.communitybbs.BB.Post.CPost;
...
public class PostBBSManager extends BaseBBSManager
{
	...
	public void parsewrite(String ar1, String ar2, String ar3, String ar4, String ar5, L2PcInstance activeChar)
	{
		...
		else
		{
			...
			else
			{
				...
				if (cp == null)
				{
					activeChar.sendPacket(new ShowBoard("<html><body><br><br><center>the post: " + idp + " does not exist !</center><br><br></body></html>", "101"));
					activeChar.sendPacket(new ShowBoard(null, "102"));
					activeChar.sendPacket(new ShowBoard(null, "103"));
				}
				else if (p != null)
	...
	private void showEditPost(Topic topic, Forum forum, L2PcInstance activeChar, int idp)
	{
		...
		{
			activeChar.sendPacket(new ShowBoard("<html><body><br><br><center>Error, this forum, topic or post does not exit !</center><br><br></body></html>", "101"));
			activeChar.sendPacket(new ShowBoard(null, "102"));
			activeChar.sendPacket(new ShowBoard(null, "103"));
		}
		else
	...
	private void showPost(Topic topic, Forum forum, L2PcInstance activeChar, int ind)
	{
		...
		{
			activeChar.sendPacket(new ShowBoard("<html><body><br><br><center>Error, this forum is not implemented yet</center><br><br></body></html>", "101"));
			activeChar.sendPacket(new ShowBoard(null, "102"));
			activeChar.sendPacket(new ShowBoard(null, "103"));
		}
