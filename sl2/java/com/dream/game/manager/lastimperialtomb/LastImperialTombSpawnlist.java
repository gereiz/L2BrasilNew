...
public class LastImperialTombSpawnlist
{
	...
	private static List<L2Spawn> _Room1SpawnList1st = new ArrayList<>();
	private static List<L2Spawn> _Room1SpawnList2nd = new ArrayList<>();
	private static List<L2Spawn> _Room1SpawnList3rd = new ArrayList<>();
	private static List<L2Spawn> _Room1SpawnList4th = new ArrayList<>();
	private static List<L2Spawn> _Room2InsideSpawnList = new ArrayList<>();
	private static List<L2Spawn> _Room2OutsideSpawnList = new ArrayList<>();
	...
	public void fill()
	{
		...
		/* _log.info("LastImperialTombSpawnlist: Loaded " + _Room1SpawnList1st.size() + " Room1 1st Npc Spawn Locations."); _log.info("LastImperialTombSpawnlist: Loaded " + _Room1SpawnList2nd.size() + " Room1 2nd Npc Spawn Locations."); _log.info("LastImperialTombSpawnlist: Loaded " + _Room1SpawnList3rd.size() + " Room1 3rd Npc Spawn Locations."); _log.info("LastImperialTombSpawnlist: Loaded " + _Room1SpawnList4th.size() + " Room1 4th Npc Spawn Locations."); _log.info("LastImperialTombSpawnlist: Loaded " + _Room2InsideSpawnList.size() + " Room2 Inside Npc Spawn Locations."); _log.info(
		 * "LastImperialTombSpawnlist: Loaded " + _Room2OutsideSpawnList.size() + " Room2 Outside Npc Spawn Locations."); */
	}
