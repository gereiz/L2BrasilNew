...
import com.dream.game.model.actor.instance.L2BoatInstance.L2BoatTrajet;
...
public class BoatManager extends XMLDocument
{
	...
	public BoatManager()
	{
		_log.info("Initializing FerryBoat Manager.");
		load();
	}
	...
	private final void load()
	{
		...
		try
		{
			File f = new File(Config.DATAPACK_ROOT, "data/xml/world/boat.xml");
			load(f);
		}
