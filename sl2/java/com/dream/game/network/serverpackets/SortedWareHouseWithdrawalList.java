...
import com.dream.game.templates.item.L2WarehouseItem;
...
public class SortedWareHouseWithdrawalList extends L2GameServerPacket
{
	...
	public static Logger _log = Logger.getLogger(SortedWareHouseWithdrawalList.class.getName());
	...
	private static List<L2WarehouseItem> createAllList(L2ItemInstance[] _items)
	{
	...
	private static List<L2WarehouseItem> createAmulettList(L2ItemInstance[] _items)
	{
		List<L2WarehouseItem> _list = new ArrayList<>();
		for (L2ItemInstance item : _items)
	...
	private static List<L2WarehouseItem> createArmorList(L2ItemInstance[] _items)
	{
		List<L2WarehouseItem> _list = new ArrayList<>();
		for (L2ItemInstance item : _items)
	...
	private static List<L2WarehouseItem> createConsumableList(L2ItemInstance[] _items)
	{
		List<L2WarehouseItem> _list = new ArrayList<>();
		for (L2ItemInstance item : _items)
	...
	private static List<L2WarehouseItem> createEtcItemList(L2ItemInstance[] _items)
	{
		List<L2WarehouseItem> _list = new ArrayList<>();
		for (L2ItemInstance item : _items)
	...
	private static List<L2WarehouseItem> createMatList(L2ItemInstance[] _items)
	{
		List<L2WarehouseItem> _list = new ArrayList<>();
		for (L2ItemInstance item : _items)
	...
	private static List<L2WarehouseItem> createOtherList(L2ItemInstance[] _items)
	{
		List<L2WarehouseItem> _list = new ArrayList<>();
		for (L2ItemInstance item : _items)
	...
	private static List<L2WarehouseItem> createRecipeList(L2ItemInstance[] _items)
	{
		List<L2WarehouseItem> _list = new ArrayList<>();
		for (L2ItemInstance item : _items)
	...
	private static List<L2WarehouseItem> createScrollList(L2ItemInstance[] _items)
	{
		List<L2WarehouseItem> _list = new ArrayList<>();
		for (L2ItemInstance item : _items)
	...
	private static List<L2WarehouseItem> createSeedList(L2ItemInstance[] _items)
	{
		List<L2WarehouseItem> _list = new ArrayList<>();
		for (L2ItemInstance item : _items)
	...
	private static List<L2WarehouseItem> createShotList(L2ItemInstance[] _items)
	{
		List<L2WarehouseItem> _list = new ArrayList<>();
		for (L2ItemInstance item : _items)
	...
	private static List<L2WarehouseItem> createSpellbookList(L2ItemInstance[] _items)
	{
		List<L2WarehouseItem> _list = new ArrayList<>();
		for (L2ItemInstance item : _items)
			if (item.isEtcItem() && item.getEtcItem().getItemType() == L2EtcItemType.SPELLBOOK && !item.getItemName().toUpperCase().startsWith("AMULET") || item.getItem().getType2() == L2Item.TYPE2_MONEY)
	...
	private static List<L2WarehouseItem> createWeaponList(L2ItemInstance[] _items)
	{
		List<L2WarehouseItem> _list = new ArrayList<>();
		for (L2ItemInstance item : _items)
