...
public enum SystemMessageId
{
	...
	/**
	 * ID: 139<br>
	 * Message: Skill $s2 had no effect on the $c1.
	 */
	...
	/**
	 * ID: 157<br>
	 * Message: Absorption character $c1 had no impact on you.
	 */
	...
	/**
	 * ID: 159<br>
	 * Message: The magic of character $c1 did not have an impact on you.
	 */
	...
	public final SystemMessage getSystemMessage()
	{
		...
		{
			_systemMessage = SystemMessage.getSystemMessage(this);
		}
