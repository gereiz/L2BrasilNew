...
import com.dream.game.model.actor.knownlist.BoatKnownList;
...
import com.dream.game.network.serverpackets.OnVehicleCheckLocation;
import com.dream.game.network.serverpackets.PlaySound;
import com.dream.game.network.serverpackets.VehicleDeparture;
import com.dream.game.network.serverpackets.VehicleInfo;
import com.dream.game.network.serverpackets.VehicleStarted;
...
{
	final static Logger _log = Logger.getLogger(L2BoatInstance.class.getName());
	...
	public void moveToLocation(int x, int y, int z, float speed)
	{
		...
		// Calculate the Nb of ticks between the current position and the
		// destination
	...
	public L2BoatTrajet setTrajet1(int idWaypoint1, int idWTicket1, int ntx1, int nty1, int ntz1, String idnpc1, String sysmess10_1, String sysmess5_1, String sysmess1_1, String sysmess0_1, String sysmessb_1)
	{
	...
	public L2BoatTrajet setTrajet2(int idWaypoint1, int idWTicket1, int ntx1, int nty1, int ntz1, String idnpc1, String sysmess10_1, String sysmess5_1, String sysmess1_1, String sysmess0_1, String sysmessb_1)
	{
	...
	/* (non-Javadoc)
	 * @see com.dream.gameserver.model.L2Character#getActiveWeaponInstance() */
	@Override
	...
	/* (non-Javadoc)
	 * @see com.dream.gameserver.model.L2Character#getActiveWeaponItem() */
	@Override
	...
	/* (non-Javadoc)
	 * @see com.dream.gameserver.model.L2Character#getSecondaryWeaponInstance() */
	@Override
	...
	/* (non-Javadoc)
	 * @see com.dream.gameserver.model.L2Character#getSecondaryWeaponItem() */
	@Override
	...
	/* (non-Javadoc)
	 * @see com.dream.gameserver.model.L2Character#getLevel() */
	@Override
	public int getLevel()
	{
		// TODO Auto-generated method stub
	...
	/* (non-Javadoc)
	 * @see com.dream.game.model.actor.L2Character#updateAbnormalEffect() */
	@Override
