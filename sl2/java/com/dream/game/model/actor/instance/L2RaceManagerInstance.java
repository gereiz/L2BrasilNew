...
import com.dream.game.model.actor.knownlist.RaceManagerKnownList;
...
import com.dream.game.network.serverpackets.MonRaceInfo;
...
public class L2RaceManagerInstance extends L2Npc
{
	...
	public void showBuyTicket(L2PcInstance player, int val)
	{
		...
		else
		{
			...
			L2ItemInstance item = ItemTable.createItem("RaceManager", 4443, 1, player, this);
