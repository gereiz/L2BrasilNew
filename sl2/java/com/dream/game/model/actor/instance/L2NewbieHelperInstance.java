...
public class L2NewbieHelperInstance extends L2Npc
{
	...
	public void showChatWindow(L2PcInstance pl)
	{
		if (pl == null)
			return;
		String filename = "no";
		if (pl.getClassId() == ClassId.darkFighter || pl.getClassId() == ClassId.darkMage || pl.getClassId() == ClassId.mage || pl.getClassId() == ClassId.fighter || pl.getClassId() == ClassId.elvenMage || pl.getClassId() == ClassId.elvenFighter || pl.getClassId() == ClassId.dwarvenFighter || pl.getClassId() == ClassId.darkMage || pl.getClassId() == ClassId.orcFighter || pl.getClassId() == ClassId.orcMage)
		{
