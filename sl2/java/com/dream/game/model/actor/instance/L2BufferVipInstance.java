...
public final class L2BufferVipInstance extends L2NpcInstance
{
	public L2BufferVipInstance(int objectId, L2NpcTemplate template)
	{
	...
	private void showMessageWindow(L2PcInstance player)
	{
		if (player.isVip())
		{
		String filename = "data/html/mods/buffervip/" + getNpcId() + ".htm";
		...
		{
			String filename = "data/html/mods/buffervip/no-vip.htm";
			NpcHtmlMessage html = new NpcHtmlMessage(getObjectId());
			html.setFile(filename);
			html.replace("%objectId%", String.valueOf(getObjectId()));
			html.replace("%npcname%", getName());
	...
	public String getHtmlPath(int npcId, int val)
	{
		...
		return "data/html/mods/buffervip/" + pom + ".htm";
	}
}