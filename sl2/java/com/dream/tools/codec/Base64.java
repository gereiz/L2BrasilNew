...
public class Base64
{
	...
	private static GZIPOutputStream gzos;
	private static OutputStream b64os;
	private static ByteArrayOutputStream baos;
	private static GZIPOutputStream gzos2;
	private static OutputStream b64os2;
	private static ByteArrayOutputStream baos2;
	private static ByteArrayOutputStream baos3;
	private static GZIPInputStream gzis;
	...
	public static byte[] decode(String s)
	{
		...
		if (bytes.length >= 2)
		{
			...
			if (bytes.length >= 4 && java.util.zip.GZIPInputStream.GZIP_MAGIC == head)
			{
				...
				try
				{
					baos3 = new java.io.ByteArrayOutputStream();
	...
	public static Object decodeToObject(String encodedObject)
	{
		...
		try
		{
			bais2 = new java.io.ByteArrayInputStream(objBytes);
			ois = new java.io.ObjectInputStream(bais2);
	...
	public static String encodeBytes(byte[] source, int off, int len, int options)
	{
		...
		if (gzip == GZIP)
		{
			...
			try
			{
				baos2 = new java.io.ByteArrayOutputStream();
				b64os2 = new Base64.OutputStream(baos2, ENCODE | dontBreakLines);
				gzos2 = new java.util.zip.GZIPOutputStream(b64os2);
