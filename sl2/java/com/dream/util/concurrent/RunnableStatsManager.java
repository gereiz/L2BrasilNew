...
public final class RunnableStatsManager
{
	private final class ClassStat
	{
		...
		public MethodStat[] _methodStats = new MethodStat[0];

		public ClassStat(Class<?> clazz)
		{
			_classStats.put(clazz, this);

			_className = clazz.getName().replace("com.dream.game.", "");
		}
	...
	private final class MethodStat
	{
		...
		public long _count;
		public long _total;
		public long _min = Long.MAX_VALUE;
		public long _max = Long.MIN_VALUE;
		...
		public void handleStats(long runTime)
		{
			_count++;
			_total += runTime;
	...
	public static enum SortBy
	{
		...
		public static final SortBy[] VALUES = SortBy.values();

		public final String _xmlAttributeName;

		public final Comparator<MethodStat> _comparator = new Comparator<>()
		{
	...
	public final Map<Class<?>, ClassStat> _classStats = new HashMap<>();
